...
from raspberry.src.task_web_ui import task_web_ui
...
if __name__ == "__main__":
    ...
    try:
        ...
        queue_aruco_detection_to_ui = Queue()
        ...
        p2 = Process(
            target=run_task,
            args=(2, task_web_ui, queue_aruco_detection_to_ui),
            name="TaskWebUI",
        )
